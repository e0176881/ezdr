...
final Handler mHandler = new Handler();
     ...
     /*   TextView loginScreen = (TextView) findViewById(R.id.link_to_login);
        ...
        updatee.setVisibility(View.GONE);
 ...
 slidingimage.setScaleType(ScaleType.FIT_XY);
  			...
  			if(response.contains("success")){
  				runOnUiThread(new Runnable() {
  				    public void run() {
  				    	...
  				    	Toast.makeText(MyHistory.this,"History Updated!", Toast.LENGTH_SHORT).show();
    ...
    void Register(){
  	...
  	public void showAlert(){
  		MyHistory.this.runOnUiThread(new Runnable() {
  		    public void run() {
  		    	AlertDialog.Builder builder = new AlertDialog.Builder(MyHistory.this);
